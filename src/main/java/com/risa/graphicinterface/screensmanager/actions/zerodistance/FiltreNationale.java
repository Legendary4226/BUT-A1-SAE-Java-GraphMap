...
public class FiltreNationale  extends AbstractAction {
    private final ZeroDistanceScreen zeroDistanceSreen;

    public FiltreNationale (ZeroDistanceScreen zeroDistanceScreen){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        edgesListModel.filterBy(TypeRoute.NATIONALE, zeroDistanceSreen.getScreensManager().getGraphSAE().getAretes() );
    }
}
